...
SRC_URI = "git://github.com/daqsys/openrex-uboot-v2015.10.git;branch=${SRCBRANCH}"

#SRCEV is the commit number, change for every rev.
SRCREV = "fc3277e32f03d1ae083aa03605db1d54d8cace4f"
